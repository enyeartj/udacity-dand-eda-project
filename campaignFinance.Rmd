...
pcf <- pcf %>%
  separate(contb_receipt_dt, c("contb_receipt_dy",
                               "contb_receipt_mo",
                               "contb_receipt_yr"), sep = "-")
pcf$contb_receipt_dy <- as.integer(pcf$contb_receipt_dy)
pcf$contb_receipt_yr <- as.integer(pcf$contb_receipt_yr)
pcf$contb_receipt_mo <- match(pcf$contb_receipt_mo, toupper(month.abb))
```
